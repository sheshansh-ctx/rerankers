...
# API-based rerankers (Cohere, Jina, MixedBread, Pinecone, Contextual)
...
# API (Contextual)
ranker = Reranker("contextual", api_key = API_KEY)
...
- ✅ Cohere, Jina, Voyage,  MixedBread, Pinecone, and Contextual API rerankers
